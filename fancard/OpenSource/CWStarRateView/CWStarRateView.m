...
//-----------hejie-----------
- (instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars image:(NSString*)image{
    if (self = [super initWithFrame:frame]) {
        _numberOfStars = numberOfStars;
        [self buildDataAndUI:image];
    }
    return self;
}
...
- (void)buildDataAndUI:(NSString *)image {
