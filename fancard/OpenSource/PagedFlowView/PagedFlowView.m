...
- (UIView *)dequeueCell:(NSInteger)index {
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    switch (orientation) {
        case PagedFlowViewOrientationHorizontal:
            pageIndex = round(_scrollView.contentOffset.x / _pageSize.width);
            break;
        case PagedFlowViewOrientationVertical:
            pageIndex = round(_scrollView.contentOffset.y / _pageSize.height);
            break;
        default:
            break;
    }
    ...
    if ([_delegate respondsToSelector:@selector(flowView:currentPageAtIndex:)]) {
        [_delegate flowView:self currentPageAtIndex:_currentPageIndex];
    }
